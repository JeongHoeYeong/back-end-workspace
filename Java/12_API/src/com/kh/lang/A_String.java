...
public class A_String {
	...
	public void method3() {
		...
		// 3. delete(int start, int eend) : StringBuilder
	 ...
	 * */
	public void method4() {
		String str = "HTML, CSS, JavaScripts,MySQL,Java,JDBC,Servlet,JSP,jQuery,MyBatis,Spring,React";

...
//			}
	 ...
	 * continue문
	 * 
	 * - continue문은 반복문 안에서 사용 - 반복문 안에서 continue를 만나면 "현재 구문" 종료 - 반복문을 빠져나가는 건 아님!
	 * 다음 반복을 계속 수행
	 */
	...
	public void method7() {
		...
		/*
		 * java.lang.Math 클ㄹ스에서 제공하는 random() 메서드 호출할 때마다 매번 다른 랜덤값을 얻어낼 수 있음
		 */
	...
	/*
	 * 사용자한테 입력받은 문자열을 세로로 출력 사용자 입력 > Hello H e l l o
	 */
	public void method8() {

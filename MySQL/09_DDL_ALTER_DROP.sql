...
ALTER TABLE dept_copy MODIFY dept_tltle VARCHAR(5);
...
ALTER TABLE member DROP FOREIGN KEY member_ib_fk;
...
/*
    ...
    - ADD [CONSTRAINT 제약조건명] FOREIGN KEY(컬럼명) REFERENCES 테이블(컬럼명)
